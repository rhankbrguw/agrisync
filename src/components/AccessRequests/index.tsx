      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed sm:absolute top-16 sm:top-full left-3 right-3 sm:left-auto sm:right-0 mt-2 sm:mt-3 w-auto max-w-sm sm:max-w-[380px] sm:w-96 max-h-[calc(100vh-5.5rem)] bg-surface border border-border shadow-2xl rounded-2xl z-50 overflow-hidden flex flex-col mx-auto sm:mx-0"
          >
