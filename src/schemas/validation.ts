...
const TYPO_MAP: Record<string, string> = {
  // Gmail typos
  'gmail.co': 'gmail.com', 'gmail.con': 'gmail.com', 'gmail.cpm': 'gmail.com', 'gmail.cm': 'gmail.com',
  'gmail.cmo': 'gmail.com', 'gmail.comm': 'gmail.com', 'gmail.om': 'gmail.com', 'gmial.com': 'gmail.com',
  'gmial.co': 'gmail.com', 'gamil.com': 'gmail.com', 'gamil.co': 'gmail.com', 'gmal.com': 'gmail.com',
  'gmaill.com': 'gmail.com', 'gmai.com': 'gmail.com', 'gmaik.com': 'gmail.com', 'gmaul.com': 'gmail.com',
  'gmaip.com': 'gmail.com', 'googlemail.co': 'googlemail.com',
  // Yahoo typos
  'yahoo.co': 'yahoo.com', 'yahoo.con': 'yahoo.com', 'yahoo.cpm': 'yahoo.com', 'yahoo.cm': 'yahoo.com',
  'yaho.com': 'yahoo.com', 'yaho.co.id': 'yahoo.co.id', 'yahooo.com': 'yahoo.com', 'ymail.co': 'ymail.com',
  // Outlook / Hotmail typos
  'outlook.co': 'outlook.com', 'outlook.con': 'outlook.com', 'outlook.cm': 'outlook.com',
  'outlok.com': 'outlook.com', 'outlok.co': 'outlook.com', 'outllok.com': 'outlook.com',
  'outook.com': 'outlook.com', 'hotmail.co': 'hotmail.com', 'hotmail.con': 'hotmail.com',
  'hotmail.cm': 'hotmail.com', 'hotmial.com': 'hotmail.com', 'hotmai.com': 'hotmail.com',
  'live.co': 'live.com', 'live.con': 'live.com',
  // iCloud typos
  'icloud.co': 'icloud.com', 'icloud.con': 'icloud.com', 'icloud.cm': 'icloud.com',
  'icluod.com': 'icloud.com', 'iclad.com': 'icloud.com',
};
...
const INVALID_TLD_MAP: Record<string, string> = {
  con: 'com', cpm: 'com', cmo: 'com', cm: 'com', comm: 'com', coom: 'com', col: 'com', vom: 'com',
};

const KNOWN_PROVIDERS = ['gmail', 'yahoo', 'outlook', 'hotmail', 'icloud', 'proton', 'ymail', 'zoho'];
...
function checkDomainTypo(domain: string): string | null {
  ...
  const main = domain.substring(0, lastDot);
  if (INVALID_TLD_MAP[tld]) return `${main}.${INVALID_TLD_MAP[tld]}`;
  if (tld === 'co' && KNOWN_PROVIDERS.some(p => main === p || main.endsWith(`.${p}`))) return `${main}.com`;
  return null;
}
...
function validateEmailDomain(email: string, ctx: z.RefinementCtx) {
  ...
  const suggested = checkDomainTypo(domain);
  if (suggested) {
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
      message: APP_STRINGS.VALIDATION.EMAIL_TYPO.replace('{0}', suggested),
    });
    return;
  }
...
export const workspaceCodeSchema = z.string()
  .trim()
  .transform(val => val.replace(/^#\s*/, '').trim().toUpperCase())
  .refine(val => PATTERNS.WORKSPACE_CODE.test(val), {
    message: APP_STRINGS.VALIDATION.COMPANY_CODE_FORMAT,
  });
